...
// I DO NOT USE THESE. THAT IS WHY THEY ARE NOT IN THE CSGO NAMESPACE.
...
namespace CSGO
{
	...
	public:
		...
		virtual void                  DebugDrawPhysCollide(const CPhysCollide *pCollide, IMaterial *pMaterial, const CSGO::matrix3x4_t& transform, const CSGO::Color &color) = 0; //79
